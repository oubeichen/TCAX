...
TCAX_PyPix pix::convert_pix(const TCAX_pPix pPix, int delPix)
{
    int i;
...
TCAX_pPix pix::convert_py_pix(const py::tuple &pyPix, TCAX_pPix pPix)
{
    int i;
...
void pix::points_append(TCAX_pPoints pPoints, double x, double y, unsigned char a)
{
    double *xBuf, *yBuf;
    unsigned char *aBuf;
    int count, capacity;
...
TCAX_pPix pix::resample_pix_ex(const TCAX_pPix pPixSrc,
                               TCAX_pPix pPixDst,
...
TCAX_pPix pix::enlarge_pix(const TCAX_pPix pPixSrc, TCAX_pPix pPixDst)
{
...
TCAX_pPix pix::bilinear_filter_internal(const TCAX_pPix pPixSrc, double offset_x, double offset_y, TCAX_pPix pPixDst)
{
...
TCAX_pPix pix::scale_filter_internal(const TCAX_pPix pPixSrc, double offset_x, double offset_y, TCAX_pPix pPixDst)
{
    const int m = 4;
