...
public:
    ...
    */
    ...
    TCAX_PyPix apply_pix_texture(TCAX_PyPix &PIX, TCAX_PyPix &texture);
     ...
     */
    //PixMask(PIX, mask)
    TCAX_PyPix apply_pix_mask(TCAX_PyPix &PIX, py::tuple &mask);
    ...
    TCAX_PyPix pix_replace_alpha(TCAX_PyPix &PIX, TCAX_PyPix &PIX_alpha);
     ...
     */
    //PixEnlarge(PIX, x, y)
    TCAX_PyPix enlarge_py_pix(TCAX_PyPix &PIX, int x, int y);
    ...
    TCAX_PyPix crop_py_pix(TCAX_PyPix &PIX, int left, int top, int right, int bottom);
     ...
     */
    //PixStrip(PIX)
    TCAX_PyPix py_pix_strip_blank(TCAX_PyPix &PIX);
     ...
     */
    //PixBlur(PIX, radius)
    TCAX_PyPix apply_gauss_blur(TCAX_PyPix &PIX, int radius);
    ...
    TCAX_PyPix combine_two_pixs(TCAX_PyPix &back, TCAX_PyPix &overlay);
    ...
    TCAX_PyPix pix_color_multiply(TCAX_PyPix &PIX, double r_f, double g_f, double b_f, double a_f);
    ...
    TCAX_PyPix pix_color_shift(TCAX_PyPix &PIX, int r, int g, int b, int a);
    ...
    TCAX_PyPix pix_color_transparent(TCAX_PyPix &PIX, uint32_t rgb);
    ...
    TCAX_PyPix pix_color_flat_rgba(TCAX_PyPix &PIX, uint32_t rgba);
     ...
     */
    //PixColorRGB(PIX, rgb)
    TCAX_PyPix pix_color_flat_rgb(TCAX_PyPix &PIX, uint32_t rgb);
     ...
     */
    //PixColorA(PIX, alpha)
    TCAX_PyPix pix_color_flat_alpha(TCAX_PyPix &PIX, unsigned int alpha);
    ...
    TCAX_PyPix bilinear_filter(TCAX_PyPix &PIX, double offset_x, double offset_y);
    ...
    TCAX_PyPix scale_filter(TCAX_PyPix &PIX, double offset_x, double offset_y);
    ...
    int big_pix_add(TCAX_PyBigPix &BIG_PIX, TCAX_PyPix &PIX, double offset_x, double offset_y, int layer);
    ...
    TCAX_PyPix convert_big_pix(TCAX_PyBigPix BIG_PIX);
     ...
     * @return TCAX_PyPix
     */
    TCAX_PyPix convert_pix(const TCAX_pPix pPix, int delPix);
     ...
     */
    TCAX_pPix convert_py_pix(const py::tuple &pyPix, TCAX_pPix pPix);
     ...
     */
    void points_append(TCAX_pPoints pPoints, double x, double y, unsigned char a);
...
private:
     ...
     * supports fractional width and height
     */
    TCAX_pPix resample_pix_ex(const TCAX_pPix pPixSrc,
                              TCAX_pPix pPixDst,
     ...
     * @return TCAX_pPix
     */
    TCAX_pPix enlarge_pix(const TCAX_pPix pPixSrc, TCAX_pPix pPixDst);
     ...
     * @return const TCAX_pPix
     */
    TCAX_pPix bilinear_filter_internal(const TCAX_pPix pPixSrc, double offset_x, double offset_y, TCAX_pPix pPixDst);
     ...
     * @return const TCAX_pPix
     */
    TCAX_pPix scale_filter_internal(const TCAX_pPix pPixSrc, double offset_x, double offset_y, TCAX_pPix pPixDst);
};
